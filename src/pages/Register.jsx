            ...
            <div className="bg-black border border-slate-800 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative ">
              ...
              <form onSubmit={handleRegister} action="">
                ...
                <div className="relative my-2">
                  <label htmlFor="phoneno" className="absolute text-sm text-orange-600 duration-300 transform -translate-y-6 scale-75 top-2 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-500 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:translate-y-6"> PhoneNo</label>
                  <input
                    type="text"
                    id="phoneno"
                    className='block w-60 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-green-500 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-gray-600 focus:border-blue-300 peer'
